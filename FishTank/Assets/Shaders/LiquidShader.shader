    ...
    SubShader
    {
                ...
                Pass
        {
         ...
         v2f vert (appdata v)
         {
            ...
            // rotate it around XY
            float3 worldPosX= RotateAroundYInDegrees(float4(o.worldPos,0),360);
            // rotate around XZ
            float3 worldPosZ = float3 (o.worldPos.y, o.worldPos.z, o.worldPos.x);     
            // combine rotations with worldPos, based on sine wave from script
            float3 worldPosAdjusted = o.worldPos + (o.worldPos  * _WobbleX)+ (worldPosZ* _WobbleZ);
         ...
         fixed4 frag (v2f i, fixed facing : VFACE) : SV_Target
         {
           ...
           return ApplyFog(facing > 0 ? finalResult: topColor,i.worldPos);
